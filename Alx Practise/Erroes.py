...
# def divide ( X,Y ):
#     if Y == 0: 
#         raise ZeroDivisionError ("Division by zero is nor allowed")
#     return X / Y
# class ValueTooHighError ( Exception):
#     """"Custom exception for handling value-too-hign"""
#     number = 10
#     if number > 10:
#       raise Exception(f"The number should nor exceed 10.({number=})")
#     print(number)